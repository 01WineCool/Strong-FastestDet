...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', type=str, default=r"C:\Users\Wu Meishun\Desktop\Python\FastestDet\checkpoint\weight_epoch_250.pth", help='.weight config')
    parser.add_argument('--img', type=str, default=r'C:\Users\Wu Meishun\Desktop\Python\YOLOV8\datasets\NEU\images\test\patches_280.jpg', help='The path of test image')
    ...
    for box in output[0]:
        ...
        cv2.rectangle(ori_img, (x1, y1), (x2, y2), (180, 255, 0), 1)
        cv2.putText(ori_img, '%.2f' % obj_score, (x1, y1 - 5), 0, 0.5, (0, 255, 0), 1)
        cv2.putText(ori_img, category, (x1, y1 - 25), 0, 0.5, (0, 255, 0), 1)
